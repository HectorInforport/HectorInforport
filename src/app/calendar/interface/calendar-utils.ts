...
export declare function getEventsInPeriod(
...
export declare function getWeekViewHeader(
  dateAdapter: DateAdapter,
  {
    viewDate,
    weekStartsOn,
...
export declare function getDifferenceInDaysWithExclusions(
  dateAdapter: DateAdapter,
  {
    date1,
    date2,
...
export declare function getWeekView(
  dateAdapter: DateAdapter,
  {
    events,
    viewDate,
...
export declare function validateEvents(
  events: CalendarEvent[],
  log: (...args: any[]) => void
): boolean;
export {};
